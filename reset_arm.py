...
def main():
    ...
    reset_joint_positions = [ 0.07728681, -0.45524168, -0.08244545, -2.65215558, -0.04077673,  2.28466263, 0.80742995]

    # target_world_position = np.array([0.4, 0, 0.40])

    reset_joint_positions = [ 0.0542114,  -0.55028691, -0.07820534, -2.43099304, -0.04260483,  1.95980732,  0.77795249]
